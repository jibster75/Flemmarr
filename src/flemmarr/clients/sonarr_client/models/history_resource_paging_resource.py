...
T = TypeVar("T", bound="HistoryResourcePagingResource")
...
class HistoryResourcePagingResource:
    ...
    Attributes:
        ...
        records (Union[None, Unset, list['HistoryResource']]):
    """
    ...
    records: Union[None, Unset, list["HistoryResource"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_records(data: object) -> Union[None, Unset, list["HistoryResource"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for records_type_0_item_data in _records_type_0:
                    records_type_0_item = HistoryResource.from_dict(records_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list["HistoryResource"]], data)

        records = _parse_records(d.pop("records", UNSET))

        history_resource_paging_resource = cls(
            page=page,
            page_size=page_size,
            sort_key=sort_key,
        ...
        return history_resource_paging_resource

...
class EpisodeResourcePagingResource:
    ...
    Attributes:
        ...
        records (Union[None, Unset, list['EpisodeResource']]):
    """
    ...
    records: Union[None, Unset, list["EpisodeResource"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_records(data: object) -> Union[None, Unset, list["EpisodeResource"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data

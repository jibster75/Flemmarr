...
class ManualImportResource:
    ...
    Attributes:
        ...
        episode_file_id (Union[None, Unset, int]):
    ...
    episode_file_id: Union[None, Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        episode_file_id: Union[None, Unset, int]
        if isinstance(self.episode_file_id, Unset):
            episode_file_id = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_episode_file_id(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        episode_file_id = _parse_episode_file_id(d.pop("episodeFileId", UNSET))

...
T = TypeVar("T", bound="MetadataResource")
...
class MetadataResource:
    ...
    Attributes:
        ...
        presets (Union[None, Unset, list['MetadataResource']]):
    ...
    presets: Union[None, Unset, list["MetadataResource"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_presets(data: object) -> Union[None, Unset, list["MetadataResource"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for presets_type_0_item_data in _presets_type_0:
                    presets_type_0_item = MetadataResource.from_dict(presets_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list["MetadataResource"]], data)

        presets = _parse_presets(d.pop("presets", UNSET))

        enable = d.pop("enable", UNSET)

        metadata_resource = cls(
            id=id,
            name=name,
            fields=fields,

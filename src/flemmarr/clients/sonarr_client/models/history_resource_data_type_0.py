...
T = TypeVar("T", bound="HistoryResourceDataType0")


@_attrs_define
class HistoryResourceDataType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        history_resource_data_type_0 = cls()
        ...
        history_resource_data_type_0.additional_properties = additional_properties
        return history_resource_data_type_0
